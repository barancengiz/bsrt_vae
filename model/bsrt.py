...
class ResNet18Enc(nn.Module):
    ...
    def __init__(self, num_Blocks=[2,2,2,2], z_dim=10, nc=3):
        ...
        self.bn1 = nn.BatchNorm2d(64)  # TODO: Remove batch norm?
...
class SRVAE(nn.Module):
    ...
    def reparameterize(mu, log_var):
        std = torch.exp(log_var / 2) # in log-space, squareroot is divide by two
...
class BSRT(nn.Module):
    def __init__(self, args, nframes=8, img_size=64, patch_size=1, in_chans=3, out_chans=3,
        ...
        spynet_path='/workspace/pretrained/spynet_final.pth'
